...
// the `coin_type` 60' (or 0x8000003C) to Elementrem.
//
// The root path for Elementrem is m/44'/60'/0'/0 according to the specification
// from https://github.com/elementrem
