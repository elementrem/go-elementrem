...
var (
	...
	authorsFileHeader = "# This is the official list of go-elementrem authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-elementrem Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-elementrem"
	}
	if startOfSentence {
		return "The go-elementrem library"
	}
	return "the go-elementrem library"
}
