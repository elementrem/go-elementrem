...
// PrecompiledAccount represents a native elementrem contract
...
// PrecompiledContracts returns the default set of precompiled elementrem
// contracts defined by the elementrem yellow paper.
