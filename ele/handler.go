...
import (
	...
	"github.com/elementrem/go-elementrem/ele/fetcher"
...
func (pm *ProtocolManager) handleMsg(p *peer) error {
	...
	case p.version < ele62 && msg.Code == GetBlockHashesMsg:
	...
	case p.version < ele62 && msg.Code == GetBlockHashesFromNumberMsg:
	...
	case p.version < ele62 && msg.Code == BlockHashesMsg:
	...
	case p.version < ele62 && msg.Code == GetBlocksMsg:
	...
	case p.version < ele62 && msg.Code == BlocksMsg:
	...
	case p.version >= ele62 && msg.Code == GetBlockHeadersMsg:
	...
	case p.version >= ele62 && msg.Code == BlockHeadersMsg:
	...
	case p.version >= ele62 && msg.Code == GetBlockBodiesMsg:
		// Decode the retrieval message
		msgStream := rlp.NewStream(msg.Payload, uint64(msg.Size))
		if _, err := msgStream.List(); err != nil {
			return err
	...
	case p.version >= ele62 && msg.Code == BlockBodiesMsg:
