...
/*
Registrar implements the Elementrem name registrar services mapping
- arbitrary strings to elementrem addresses
- hashes to hashes
...
// Registrar's backend is defined as an interface (implemented by xele, but could be remote)
