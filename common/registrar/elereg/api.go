...
// registryAPIBackend is a backend for an Elementrem Registry.
...
// PrivateRegistarAPI offers various functions to access the Elementrem registry.
...
func NewPrivateRegistarAPI(config *core.ChainConfig, bc *core.BlockChain, chainDb eledb.Database, txPool *core.TxPool, am *accounts.Manager) *PrivateRegistarAPI {
