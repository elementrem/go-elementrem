...
func (c *Console) init(preload []string) error {
	...
	if c.prompter != nil {
		...
		// Assign the jele.unlockAccount and jele.newAccount in the Console the original web3 callbacks.
		// These will be called by the jele.* methods after they got the password from the user and send
