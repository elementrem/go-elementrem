...
# 1. install gele for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gele
# 5. create gele, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ELEMENTREM_SOCKET
...
!define APPNAME "Gele"
!define DESCRIPTION "Official Go implementation of the Elementrem protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gele is installed global
