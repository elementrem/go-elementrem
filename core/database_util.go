...
func GetHeaderRLP(db eledb.Database, hash common.Hash) rlp.RawValue {
...
// found.
func GetHeader(db eledb.Database, hash common.Hash) *types.Header {
...
func GetBodyRLP(db eledb.Database, hash common.Hash) rlp.RawValue {
...
func GetBody(db eledb.Database, hash common.Hash) *types.Body {
...
// none found.
func GetTd(db eledb.Database, hash common.Hash) *big.Int {
...
func GetBlock(db eledb.Database, hash common.Hash) *types.Block {
...
func GetBlockReceipts(db eledb.Database, hash common.Hash) types.Receipts {
...
func WriteBody(db eledb.Database, hash common.Hash, body *types.Body) error {
...
func WriteTd(db eledb.Database, hash common.Hash, td *big.Int) error {
...
func WriteBlockReceipts(db eledb.Database, hash common.Hash, receipts types.Receipts) error {
...
func DeleteBlockReceipts(db eledb.Database, hash common.Hash) {
...
func WriteChainConfig(db eledb.Database, hash common.Hash, cfg *ChainConfig) error {
...
func GetChainConfig(db eledb.Database, hash common.Hash) (*ChainConfig, error) {
