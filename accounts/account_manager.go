...
// See https://github.com/elementrem/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package accounts
...
type Account struct {
	Address common.Address // Elementrem account address derived from the key
...
// ImportPreSaleKey decrypts the given Elementrem presale wallet and stores
