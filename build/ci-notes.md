...
people to build go-elementrem using the standard toolchain without any particular package
...
To allow reproducible builds of go-elementrem noneleeless that don't need network access
...
We want to build go-elementrem with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Eelementrem/+archive/ubuntu/elementrem/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/elementrem-unstable-1.5.0+xenial
    $ dpkg-buildpackage

Built packages are placed in the dist/ directory.

    $ cd ..
    $ dpkg-deb -c gele-unstable_1.5.0+xenial_amd64.deb
