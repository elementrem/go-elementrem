...
const (
	// Protocol messages belonging to ele/61
	StatusMsg                   = 0x00
	...
	// Protocol messages belonging to ele/62 (new protocol from scratch)
	// StatusMsg          = 0x00 (uncomment after ele/61 deprecation)
	// NewBlockHashesMsg  = 0x01 (uncomment after ele/61 deprecation)
	// TxMsg              = 0x02 (uncomment after ele/61 deprecation)
	GetBlockHeadersMsg = 0x03
	BlockHeadersMsg    = 0x04
	GetBlockBodiesMsg  = 0x05
	BlockBodiesMsg     = 0x06
	// 	NewBlockMsg       = 0x07 (uncomment after ele/61 deprecation)
