...
// Spec at https://github.com/elementrem/wiki/wiki/ICAP:-Inter-exchange-Client-Address-Protocol
...
func parseICAP(s string) (Address, error) {
	...
	// checksum is ISO13616, Elementrem address is base-36
...
func clientIdentToIndirectICAP(instCode, clientIdent string) (string, error) {
	...
	// currently ELE is only valid asset identifier
	s := join("ELE", instCode, clientIdent)
