...
// ReleaseOracle is an Elementrem contract to store the current and previous
// versions of the go-elementrem implementation. Its goal is to allow Gele to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gele releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gele release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Elementrem user, either
